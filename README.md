...
$$ sim(k,i) = \sum_{u=1}^m (R_{u, k}-\overline{R_{k}}) (R_{u, i}-\overline{R_{i}}) \over \sqrt \sum_{u=1}^m (R_{u, k}-\overline{R_{k}})^{2} \sum_{u=1}^m (R_{u, i}-\overline{R_{i}})^{2}  $$

$$ sim(k,i) = \sum_{u=1}^m (R_{u, k}-\overline{R_{k}}) (R_{u, i}-\overline{R_{i}}) \over \frac \sqrt \sum_{u=1}^m (R_{u, k}-\overline{R_{k}})^{2} \sum_{u=1}^m (R_{u, i}-\overline{R_{i}})^{2} $$
